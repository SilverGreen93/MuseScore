...
void NoteInputPreferencesModel::load()
{
    ...
    notationConfiguration()->pitchNotationSPNChanged().onNotify(this, [this]() {
...
{
    return notationConfiguration()->pitchNotationSPN();
}
...
void NoteInputPreferencesModel::setPitchNotationSPN(bool value)
{
    ...
    notationConfiguration()->setPitchNotationSPN(value);
}
